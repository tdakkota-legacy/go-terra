...
func (m UpdateSign) Append(cur *cursor.Cursor) (err error) {
	{
		err := cur.WriteInt16(m.SignID)
		if err != nil {
			return err
		}
	}
	...
	{
		err := cur.WriteUint8(m.SignFlags)
		if err != nil {
			return err
		}
	}
...
func (m *UpdateSign) Scan(cur *cursor.Cursor) (err error) {
	{
